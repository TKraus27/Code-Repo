...
public class AssemblerTest {
        ...
        public void test2() {
          ...
          List<Instruction> input = new LinkedList<Instruction>();
          // label1: addu $t0, $zero, $zero
          input.add(InstructionFactory.CreateAddu(12, 0, 0, "label1"));
          // addu $s0, $s7, $t4
          input.add(InstructionFactory.CreateAddu(16, 23, 12));
          // blt  $s0,$t0,label1
          input.add(InstructionFactory.CreateBge(16, 8, "label2"));
          // addiu $s1,$s2,0xF00000
          input.add(InstructionFactory.CreateAddiu(17, 18, 0xF000FF));

          input.add(InstructionFactory.CreateOr(9, 8, 16, "label2"));


          // Phase 1
          Instruction[] phase1_expected = {
                  InstructionFactory.CreateAddu(12, 0, 0, "label1"), // label1: addu $t0, $zero, $zero
                  InstructionFactory.CreateAddu(16, 23, 12), // addu $s0, $s7, $t4
                  InstructionFactory.CreateSlt(1, 16, 8),  // slt $at,$s0,$t0
                  InstructionFactory.CreateBeq(1, 0, "label2"),     // bne $at,$zero,label1
                  InstructionFactory.CreateLui(1, 0x00F0), // lui $at, 0x00F0
                  InstructionFactory.CreateOri(1, 1, 0x00FF), // ori $at, $at 0x0000
                  InstructionFactory.CreateAddu(17, 18, 1), // addu $s1,$s2,$at
                  InstructionFactory.CreateOr(9, 8, 16, "label2")
          };

          // Phase 2
          Instruction[] phase2_expected = {
                  InstructionFactory.CreateAddu(12,0, 0, "label1"),//new Instruction(2,8,0,0,0,0,0,1,0),
                  InstructionFactory.CreateAddu(16,23,12),//new Instruction(2,16,23,12,0,0,0,0,0),
                  InstructionFactory.CreateSlt(1, 16, 8),//new Instruction(8,1,16,8,0,0,0,0,0),
                  InstructionFactory.CreateBeq(1, 0, 0x00000003),//new Instruction(6,0,1,0,0xfffffffc,0,0,0,1),
                  InstructionFactory.CreateLui(1, 0x00F0),// new Instruction(9,0,0,1,0x00F0,0,0,0,0),
                  InstructionFactory.CreateOri(1, 1, 0x00FF),// new Instruction(10,0,1,1,0x0000,0,0,0,0),
                  InstructionFactory.CreateAddu(17, 18, 1),// new Instruction(2,17,18,1,0,0,0,0,0)
                  InstructionFactory.CreateOr(9, 8, 16, "label2")
          };
